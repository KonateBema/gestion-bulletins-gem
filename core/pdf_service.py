...
def generate_bulletin_pdf(etudiant, classe,semestre):
    ...
    # =====================================================
    logo = get_image(
        os.path.join(settings.BASE_DIR, "core/static/logonew.jpeg"),
        1.6 * cm,
        2.5 * cm,
        "LOGO"
    )
    ...
    header = Table(
        [[cadre_universite, cadre_etudiant, cadre_qr]]
    )
    ...
    if str(semestre) in ["1", "S1"]:
        ...
        f"""
        <b>1er Semestre</b><br/>
        Moyenne : {safe_round(moyenne_s1):.2f}/20<br/>
        Rang : {rang_s1}
        """,
         SMALL
       )
       ...
       rappel_semestre = Paragraph(
         ...
         Moyenne : {safe_round(moyenne_s2):.2f}/20<br/>
         Rang : {rang_s2}
         """,
         SMALL
    )
    ...
    recap_data = [
       ...
       [
        ...
        f"Moyenne : {safe_round(moyenne_generale):.2f} / 20\n"
        f"Rang : {rang_general}",
    ...
    footer_text = (
        """
        Établissement immatriculé auprès du Ministère de l'Enseignement Supérieur et de la Recherche Scientifique de la Côte d'ivoire sous:<br/>
        Décision n° 624 / MESRS / DGES / DESUP / Kkj 8 OCT. 2019 - Arrêté n° 625 / MESRS / DGES / DESUP / Kkj 8 OCT. 2019<br/>
        Décision n° 626 / MESRS / DGES / DESUP / Kkj 8 OCT. 2019 - Arrêté n° 627 / MESRS / DGES / DESUP / Kkj 8 OCT. 2019<br/>
        GROUPE EXPERT-MÉTIER, Cocody II Plateaux, ENA RUE J9<br/>
        08 BP 2276 ABIDJAN 08 – Tél : +225 2722204432/0150536686– RCCM : CI-ABJ_2019-A-13062<br/>
        <link href="https://www.embs-ci.com">www.embs-ci.com</link> / Email : contact@embs-ci.com &nbsp;&nbsp;GROUPE EXPERT MÉTIER S.A.<br/>
        édité le %s
        """
