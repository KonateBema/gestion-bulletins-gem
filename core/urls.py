...
#   path('lmd/', include('lmd.urls')),
    ...
    # path("grandes-unites/",grande_unite_list,name="grande_unite_list"),
    # path("grandes-unites/ajouter/",views.grande_unite_add,name="grande_unite_add"),
    # path("grandes-unites/<int:pk>/modifier/",views.grande_unite_edit, name="grande_unite_edit"),
...
path(
    "grandes-unites/",
    views.grande_unite_list,
    name="grande_unite_list"
),

path(
    "grandes-unites/ajouter/",
    views.grande_unite_add,
    name="grande_unite_add"
),

path(
    "grandes-unites/<int:pk>/modifier/",
    views.grande_unite_edit,
    name="grande_unite_edit"
),

path(
    "grandes-unites/<int:pk>/supprimer/",
    views.grande_unite_delete,
    name="grande_unite_delete"
),
path(
    "etudiants/export-pdf/",
    views.export_etudiants_pdf,
    name="export_etudiants_pdf"
),
]